...
<body>
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      <li class="nav-item active">
        <a class="nav-link" href="./loginlayout.php">Login <span class="sr-only">(current)</span></a>
      </li>
  ...
  <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
   ...
   <form class= "mouni" method="post" id="formregister">  
       <div id="registermessage"></div>
       <h1><center>Sign Up to book tickets</center></h1>
  ...
  <button type="submit" name="signup" class="btn btn-primary">Sign Up</button>
       <br>
       <br>
       <button type="button" onclick="location.href='./loginlayout.php'" class="btn btn-primary">Login into existing account</button>
</form> 
  </div>   
